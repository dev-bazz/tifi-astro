    ...
    return (
        ...
        >
            <div className="  font-noto md:mt-8 flex justify-between items-center md:rounded-2xl border-b md:border  md:border-[##EAECF0] bg-white md:shadow-md max-w-[73rem] mx-auto py-4 px-5">
                <div
                className="flex justify-between items-center space-x-8 w-full md:w-auto"
                >
                    <a href="/">
                    <img src="/tifi.svg" alt="Tifi Logo" className="w-[44px] h-[20px]" />
                    </a>
                    <button
                    ...
                    <ul className="flex flex-col md:flex-row  items-center space-y-6 md:space-y-0 md:space-x-8 ">
                        {navLinks.map((link, index) => (
                            <li className={`${link.sub && 'group'} relative`} key={index} >
                                ...
                                {link.sub && (
                                    <div
                                    className=" absolute border top-5 left-0 w-[180px] bg-white shadow-md rounded-2xl py-4 px-5 hidden group-hover:block hover:block "
                ...
                >
                    <a href="#">
                        <button
                            className=" font-bold font-inter bg-[#FF601F] text-white px-5 py-3 rounded-[8px] hover:bg-[#FF4F00] transition-all duration-300 ease-in-out"
                        >
                            LET'S TALK
                        </button>
                    </a>
